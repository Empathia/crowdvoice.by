...
Class(CV, 'DiscoverTrendingOrganizationsTab').inherits(Widget)({
    ...
    prototype : {
        ...
        /* Fetch /discover/trending/organizations and call method to render them.
        ...
        fetch : function fetch() {
            ...
            API.getTrendingOrganizations(this._handleFetchResults.bind(this));
        },

        /* Handle the API getTrendingOrganizations endpoint response.
