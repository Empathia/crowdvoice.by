...
Class(CV, 'DiscoverTrendingUpdatedVoicesTab').inherits(Widget)({
    ...
    prototype : {
        ...
        /* Fetch /discover/trending/updatedVoices and call method to render them.
        ...
        fetch : function fetch() {
            ...
            API.getTrendingUpdatedVoices(this._handleFetchResults.bind(this));
        },
