...
Class(CV, 'DiscoverNewPeopleTab').inherits(Widget)({
    ...
    prototype : {
        ...
        /* Fetch /discover/new/people and call method to render them.
        ...
        fetch : function fetch() {
            ...
            API.getNewPeople(this._handleFetchResults.bind(this));
        },

        /* Handle the API getNewPeople endpoint response.
        ...
        /* Render the getNewPeople response EntityCards.
