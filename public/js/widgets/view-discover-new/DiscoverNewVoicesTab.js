...
Class(CV, 'DiscoverNewVoicesTab').inherits(Widget)({
    ...
    prototype : {
        ...
        /* Fetch /discover/new/voices and call method to render them.
        ...
        fetch : function fetch() {
            ...
            API.getNewVoices(this._handleFetchResults.bind(this));
        },
