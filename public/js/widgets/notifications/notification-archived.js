...
Class(CV, 'NotificationArchived').inherits(CV.Notification)({
    ELEMENT_CLASS : 'cv-notification archived',
    HTML : '\
        <div>\
    ...
    prototype : {
        init : function init(config) {
            ...
            if(this.itemType == 'entity'){
                ...
                this.dom.updateText(this.mainText, this.actionDoer.name + ' ' + this.actionDoer.lastname + ' archived:');
