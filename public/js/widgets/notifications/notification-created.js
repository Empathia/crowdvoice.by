...
Class(CV, 'NotificationCreated').inherits(CV.Notification)({
    ...
    prototype : {
        init : function init(config) {
            ...
            if(this.itemType == 'entity'){
                ...
                this.dom.updateText(this.mainText, this.actionDoer.name + ' ' + this.actionDoer.lastname + ' created an organization:');
            } else if (this.itemType == 'voice'){
                new CV.VoiceCoverMini({data:this.voice}).render(this.entityVoice);
                this.dom.updateText(this.mainText, this.actionDoer.name + ' ' + this.actionDoer.lastname + ' created a voice:');
            }
