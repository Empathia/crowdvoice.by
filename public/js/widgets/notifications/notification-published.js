...
Class(CV, 'NotificationPublished').inherits(CV.Notification)({
    ELEMENT_CLASS : 'cv-notification published',
    HTML : '\
        <div>\
    ...
    prototype : {
        init : function init(config) {
            ...
            if(this.itemType == 'entity'){
                ...
                this.dom.updateText(this.mainText, this.actionDoer.name + ' ' + this.actionDoer.lastname + ' published:');
