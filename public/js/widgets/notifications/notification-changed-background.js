...
Class(CV, 'NotificationChangedBackground').inherits(CV.Notification)({
    ELEMENT_CLASS : 'cv-notification changed-background',
    HTML : '\
        <div>\
    ...
    prototype : {
        init : function init(config) {
            ...
            this.dom.updateText(this.mainText, this.actionDoer.name + ' ' + this.actionDoer.lastname + ' changed background.');
