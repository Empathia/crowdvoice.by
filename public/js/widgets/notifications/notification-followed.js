...
Class(CV, 'NotificationFollowed').inherits(CV.Notification)({
    ...
    prototype : {
        init : function init(config) {
            ...
            if(this.itemType == 'entity' && this.entity.id == currentPerson.id){
                $(this.entityVoice).addClass('-empty');
                this.dom.updateText(this.mainText, this.actionDoer.name + ' ' + this.actionDoer.lastname + ' followed you.');
            } else {
                ...
                this.dom.updateText(this.mainText, this.actionDoer.name + ' ' + this.actionDoer.lastname + ' followed:');
            }
