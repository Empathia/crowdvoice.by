Class(CV, 'PostDetailControllerUnapproved').includes(NodeSupport, CustomEventSupport)({
    prototype : {
        _socket : null,
        ...
        _bindEvents : function _bindEvents() {
            ...
            this._socket.on('unapprovedMonthPosts', this._updateRegistryRef);
        ...
        _requestSiblings : function _requestSiblings() {
            ...
            if (prev && (!this.registry.get(prev))) {
                this._socket.emit('getUnapprovedMonthPosts', App.Voice.id, prev);
            }

            if (next && (!this.registry.get(next))) {
                this._socket.emit('getUnapprovedMonthPosts', App.Voice.id, next);
            }
        ...
        destroy : function destroy() {
            ...
            this._socket.removeListener('unapprovedMonthPosts', this._updateRegistry);
            return null;
        }
    }
});