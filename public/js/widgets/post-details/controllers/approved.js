    ...
    prototype : {
       registry : CV.PostsRegistry,
        ...
        _bindEvents : function _bindEvents() {
            ...
            this.socket.on('approvedMonthPosts', this.updateRegistryRef);
        },
        ...
        _requestSiblings : function _requestSiblings(monthIndex) {
            ...
            if (prevMonthString) {
                ...
                if (!prev) {
                    this.socket.emit('getApprovedMonthPosts', App.Voice.id, prevMonthString);
                } else {
            ...
            if (nextMonthString) {
                ...
                if (!next) {
                    this.socket.emit('getApprovedMonthPosts', App.Voice.id, nextMonthString);
                } else {
        ...
        destroy : function destroy() {
            ...
            this.socket.removeListener('approvedMonthPosts', this.updateRegistryRef);
            return null;
        }
    }
});
