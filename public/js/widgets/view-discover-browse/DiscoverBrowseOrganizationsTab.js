...
Class(CV, 'DiscoverBrowseOrganizationsTab').inherits(Widget)({
    ...
    prototype : {
        ...
        /* Fetch /browse/featured/organizations and call method to render them.
        ...
        fetch : function fetch() {
            ...
            API.getBrowseFeaturedOrganizations(this._handleFetchResults.bind(this));
        },

        /* Handle the API getBrowseFeaturedOrganizations endpoint response.
        ...
        /* Render the getBrowseFeaturedOrganizations response EntityCards.
