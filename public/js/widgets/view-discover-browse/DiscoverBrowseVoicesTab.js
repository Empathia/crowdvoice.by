...
Class(CV, 'DiscoverBrowseVoicesTab').inherits(Widget)({
    ELEMENT_CLASS : 'responsive-width-voice-covers -rel',
    ...
    prototype : {
        ...
        /* Fetch /browse/featured/voices and call method to render them.
        ...
        fetch : function fetch() {
            ...
            API.getBrowseFeaturedVoices(this._handleFetchResults.bind(this));
        },

        /* Handle the API getBrowseFeaturedVoices endpoint response.
