...
ACL.allow(['index', 'show', 'new', 'create', 'edit', 'update', 'destroy', 'updatePositions'], 'admin.featuredOrganizations', 'Admin', function (acl, args, next) {
  return next(null, true);
});

ACL.allow(['index', 'show', 'new', 'create', 'edit', 'update', 'destroy'], 'admin.featuredPeople', 'Admin', function (acl, args, next) {
  return next(null, true);
});

ACL.allow(['index', 'show', 'new', 'create', 'edit', 'update', 'destroy'], 'admin.featuredVoices', 'Admin', function (acl, args, next) {
  return next(null, true);
});
