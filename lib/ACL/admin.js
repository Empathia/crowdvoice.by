...
ACL.allow(['index', 'show', 'new', 'create', 'edit', 'update', 'destroy', 'updatePositions'], 'admin.featuredVoices', 'Admin', function (acl, args, next) {
  return next(null, true);
});

ACL.allow(['index', 'show', 'new', 'create', 'edit', 'update', 'destroy', 'updatePositions'], 'admin.featuredEntities', 'Admin', function (acl, args, next) {
  return next(null, true);
});
