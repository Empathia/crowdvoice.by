...
ACL.allow('isProfileNameAvailable', 'entities', 'Person', function(acl, data, next) {
...
ACL.allow('edit', 'entities', 'Person', function(acl, data, next) {
  if (data.entity.profileName === data.currentPerson.profileName) {
    return next(null, { isAllowed : true });
  } else {
    return next(null, { isAllowed : false });
...
ACL.allow('update', 'entities', 'Person', function(acl, data, next) {
  if (data.entity.profileName === data.currentPerson.profileName) {
    return next(null, { isAllowed : true });
  } else {
    return next(null, { isAllowed : false });
