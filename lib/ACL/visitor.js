...
ACL.allow('isEmailAvailable', 'entities', 'Visitor', function(acl, data, next) {
  return next(null, { isAllowed : false });
});
...
ACL.allow(['index', 'show', 'new', 'create', 'edit', 'update', 'destroy'], 'admin.people', 'Visitor', function(alc, data, next) {
  return next(null, false);
});

ACL.allow(['index', 'show', 'new', 'create', 'edit', 'update', 'destroy'], 'admin.organizations', 'Visitor', function(alc, data, next) {
  return next(null, false);
});

ACL.allow(['index', 'show', 'new', 'create', 'edit', 'update', 'destroy'], 'admin.users', 'Visitor', function(alc, data, next) {
  return next(null, false);
});

ACL.allow(['index', 'show', 'new', 'create', 'edit', 'update', 'destroy'], 'admin.voices', 'Visitor', function(alc, data, next) {
  return next(null, false);
});

ACL.allow(['index', 'show', 'new', 'create', 'edit', 'update', 'destroy'], 'admin.topics', 'Visitor', function(alc, data, next) {
  return next(null, false);
});
