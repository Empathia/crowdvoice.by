...
ACL.allow(['create', 'preview'], 'posts', 'Visitor', function(acl, data, next) {
  /* data = {
...
ACL.allow(['update', 'destroy', 'uploadPostImage', 'savePost', 'unsavePost', 'deleteOlderThan', 'deleteAllUnmoderated'], 'posts', 'Visitor', function(acl, data, next) {
