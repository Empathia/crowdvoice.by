...
var FeedInjector = Class('FeedInjector')({
  ...
  prototype: {
    ...
    entityFollowsEntity: function (entityFollowerModel, whoId, followersOf, callback) {
    },

    entityFollowsVoice: function (voiceFollowerModel, whoId, followersOf, callback) {
    },

    entityArchivesVoice: function (voiceModel, whoId, followersOf, callback) {
    },

    entityUpdatesAvatar: function (entityModel, whoId, followersOf, callback) {
    },

    entityUpdatesBackground: function (entityModel, whoId, followersOf, callback) {
    },

    entityBecomesOrgPublicMember: function (entityMembershipModel, whoId, followersOf, callback) {
    },

    voiceIsPublished: function (voiceModel, whoId, followersOf, callback) {
    },

    voiceNewPosts: function (voiceModel, whoId, followersOf, callback) {
    },

    voiceNewTitle: function (voiceModel, whoId, followersOf, callback) {
    },

    voiceNewDescription: function (voiceModel, whoId, followersOf, callback) {
    },

    voiceNewPublicContributor: function (voiceCollaboratorModel, whoId, followersOf, callback) {
    },
