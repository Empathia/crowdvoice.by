...
router.route('/discover/new/voices')
  .get(DiscoverController.prototype.filterAction(DiscoverController, 'newVoices'))
router.route('/discover/new/people')
  .get(DiscoverController.prototype.filterAction(DiscoverController, 'newPeople'))
router.route('/discover/new/organizations')
  .get(DiscoverController.prototype.filterAction(DiscoverController, 'newOrganizations'))
...
router.route('/:profileName/myVoices')
  .get(EntitiesController.prototype.filterAction(EntitiesController, 'myVoices'));
...
router.route('/:profileName/:voice_slug/follow')
