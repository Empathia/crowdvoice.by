...
router.route('/admin/featuredPeople')
  .get(Admin.FeaturedPeopleController.index)

router.route('/admin/featuredPeople/new')
  .get(Admin.FeaturedPeopleController.new)
  .post(Admin.FeaturedPeopleController.create)

router.route('/admin/featuredPeople/:entityId*)
  .get(Admin.FeaturedPeopleController.getEntity)

router.route('/admin/featuredPeople/:entityId')
  .get(Admin.FeaturedPeopleController.show)
  .delete(Admin.FeaturedPeopleController.destroy)

router.route('/admin/featuredPeople/:entityId/edit')
  .get(Admin.FeaturedPeopleController.edit)
  .put(Admin.FeaturedPeopleController.update)
