...
// Featured People
router.route('/admin/featuredPeople')
  .get(Admin.FeaturedPeopleController.prototype.index)

router.route('/admin/featuredPeople/new')
  .get(Admin.FeaturedPeopleController.prototype.new)
  .post(Admin.FeaturedPeopleController.prototype.create)

router.route('/admin/featuredPeople/updatePositions')
  .post(Admin.FeaturedPeopleController.prototype.updatePositions)

router.route('/admin/featuredPeople/:entityId*')
  .get(Admin.FeaturedPeopleController.prototype.getEntity)

router.route('/admin/featuredPeople/:entityId')
  .get(Admin.FeaturedPeopleController.prototype.show)
  .delete(Admin.FeaturedPeopleController.prototype.destroy)

router.route('/admin/featuredPeople/:entityId/edit')
  .get(Admin.FeaturedPeopleController.prototype.edit)
  .put(Admin.FeaturedPeopleController.prototype.update)
...
// Anonymous profile
router.route(/(^\/anonymous_[a-zA-Z0-9]+)(\/?)((([a-zA-Z0-9]*-?[a-zA-Z0-9]*)+)?)(\/?)$/).get(function(req, res, next) {
  var url = '/anonymous/';

  if (req.params[2]) {
    url = url + req.params[2];
  }

  res.redirect(url);
});

router.route('/anonymous/:voice_slug*')
  .all(VoicesController.prototype.getActiveVoice);

router.route('/anonymous/:voice_slug')
  .get(VoicesController.prototype.show);
...
router.route('/:profileName/removeEntity')
  .post(OrganizationsController.prototype.removeEntity);
router.route('/:profileName/leaveOrganization')
  .post(OrganizationsController.prototype.leaveOrganization);
router.route('/:profileName/requestMembership')
  .post(OrganizationsController.prototype.requestMembership);
...
router.route('/:profileName/notifications/markAsRead')
  .post(NotificationsController.prototype.markAsRead);
...
router.route('/:profileName/:voiceSlug/follow')
  .get(VoicesController.prototype.filterAction(VoicesController, 'follow'));
...
router.route('/:profileName/:voiceSlug/archive')
...
router.route('/:profileName/:voiceSlug/googleNews/:q')
  .get(SearchFrom.prototype.google);

router.route('/:profileName/:voiceSlug/youtube/:q')
    .get(SearchFrom.prototype.youtube);
