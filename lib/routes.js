...
router.route('/:profile_name/saved_posts')
  .get(PeopleController.prototype.filterAction(PeopleController, 'saved_posts'));
...
router.route('/:profileName/:voiceSlug/:postId/save_post')
  .post(PostsController.prototype.filterAction(PostsController, 'savePost'))
