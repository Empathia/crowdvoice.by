...
router.route('/signup/isProfileNameAvailable')
  .post(EntitiesController.prototype.isProfileNameAvailable);
...
router.route('/:profileName/feed')
  .get(PeopleController.prototype.filterAction(PeopleController, 'feed'));
...
router.route('/:profileName/report')
  .get(EntitiesController.prototype.filterAction(EntitiesController, 'reportEntity'));
