...
K.EntitiesPresenter = Module('EntitiesPresenter')({

  build: function (entities, currentPerson, callback) {
        ...
        Promise.resolve()
          ...
          .then(function () {
            return K.EntityFollower.query()
              ...
              .then(function (count) {
                entityInstance.entityFollowingCount = +count[0].count

                return Promise.resolve()
              })
          })
          .then(function () {
            entityInstance.entityFollowingCount += fetchEntity.followedVoices.filter(function (v) {
          ...
          .then(function () {
            ...
            return K.EntityFollower.query()
              ...
              .then(function (count) {
                entityInstsance.followed = +count[0].count > 0
          ...
          .then(function () {
            ...
            return K.EntityFollower.query()
              ...
              .then(function (followers) {
                entityInstance.followersOwnedByCurrentPerson = followers.map(function (row) {
