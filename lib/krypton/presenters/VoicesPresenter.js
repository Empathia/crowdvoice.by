...
var EntitiesPresenter = require(path.join(process.cwd(), 'lib', 'krypton', 'presenters', 'EntitiesPresenter.js'))
var TopicsPresenter = require(path.join(process.cwd(), 'lib', 'krypton', 'presenters', 'TopicsPresenter.js'))
    ...
    return new Promise(function (resolve, reject) {
      ...
      async.eachLimit(voices, 1, function (voice, nextVoice) {
        ...
        Promise.resolve()
          ...
          .then(function () {
            return EntitiesPresenter.build([fetchVoice.owner], currentPerson)
              .then(function (pres) {
          ...
          .then(function () {
            return TopicsPresenter.build(fetchVoice.topics, currentPerson)
              .then(function (pres) {
                voiceInstance.topics = pres[0]

                return Promise.resolve()
              })
          })
          .then(function () {
            return EntitiesPresenter.build(fetchVoice.followers, currentPerson)
              .then(function (pres) {
                voiceInstance.followers = pres[0]
            ...
            return K.EntityFollower.query()
              ...
              .then(function (followers) {
                voiceInstance.followersOwnedByCurrentPerson = followers.map(function (f) {
                  return hashids.encode(f.entity_id)
                })
          ...
          .then(function () {
            return voice.getPostsCount()
              .then(function (count) {
                voiceInstance.postsCount = count
