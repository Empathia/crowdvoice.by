...
require(path.join(process.cwd(), 'lib', 'krypton', 'presenters', 'EntitiesPresenter.js'))
require(path.join(process.cwd(), 'lib', 'krypton', 'presenters', 'TopicsPresenter.js'))
    ...
    return new Promise(function (resolve, reject) {
      ...
      async.eachLimit(voices, 1, function (voice, nextVoice) {
        ...
        Promise.resolve()
          ...
          .then(function () {
            return fetchVoice.getPostsCount()
              .then(function (count) {
