    ...
    return new Promise(function (resolve, reject) {
      ...
      async.eachLimit(threads, 1, function (thread, nextThread) {
        ...
        Promise.resolve()
          ...
          .then(function () {
            // TODO:
            //   - We should ignore hidden messages, maybe.  Need to check with
            //     Noel on what he'll need for the pagination.
            threadInstance.totalMessages = fetchThread.messages.length
          ...
          .then(function () {
            ...
            return Promise.each(fetchThread.messages,
              function (message) {
                return message.isPersonSender(fetchCurrentPerson)
                  .then(function (isMsgSender) {
